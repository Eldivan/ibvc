...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post children_url, params: { child: { date_birth: @child.date_birth, name: @child.name, sex: @child.sex, user_id: @child.user_id } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { date_birth: @child.date_birth, name: @child.name, sex: @child.sex, user_id: @child.user_id } }
