...
class DepartamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departament" do
    assert_difference('Departament.count') do
      post departaments_url, params: { departament: { departament_head: @departament.departament_head, name: @departament.name, user_id: @departament.user_id } }
    end
  ...
  test "should update departament" do
    patch departament_url(@departament), params: { departament: { departament_head: @departament.departament_head, name: @departament.name, user_id: @departament.user_id } }
